...
namespace Honeti
{
    ...
    public class I18N : MonoBehaviour
    {
        ...
        /// Default language.
        /// </summary>
        private static LanguageCode _defaultLang = LanguageCode.EN_GB;
        ...
        /// </summary>
        [SerializeField]
        private LanguageCode _gameLang = LanguageCode.EN_GB;
        /// <summary>
        /// Returned text when there is no translation.
        /// </summary>
        public string _noTranslationText = "Translation missing for {0}";
        /// <summary>
        /// Language file asset.
